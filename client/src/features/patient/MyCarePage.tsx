  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      <section
        ...
        className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-950 text-white p-6 sm:p-8 shadow-xl"
      >
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-3">
            {/* National Health ID Verification Seal */}
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-extrabold bg-emerald-500/20 text-emerald-300 border border-emerald-400/30 backdrop-blur-xs">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              <span className="inline-flex items-center gap-1 px-3 py-1 rounded-xl text-xs font-bold bg-rose-500/20 text-rose-200 border border-rose-500/40">
              ...
              {overview?.profile.allergies.map((allergy, i) => (
                <span
                  key={i}
                  className="inline-flex items-center gap-1 px-3 py-1 rounded-xl text-xs font-bold bg-amber-500/20 text-amber-200 border border-amber-500/40"
              ...
              {overview?.profile.chronicConditions.map((cond, i) => (
                <span
                  key={i}
                  className="inline-flex items-center gap-1 px-3 py-1 rounded-xl text-xs font-bold bg-sky-500/20 text-sky-200 border border-sky-500/40"
                >
          ...
          <div className="flex flex-wrap sm:flex-nowrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-3 min-h-[48px] rounded-xl font-semibold text-sm bg-white/10 hover:bg-white/20 text-white border border-white/20 backdrop-blur-xs transition-all focus:outline-none focus:ring-2 focus:ring-white/40 cursor-pointer"
            >
            ...
            <a
              href="tel:108"
              className="inline-flex items-center justify-center gap-2 px-5 py-3 min-h-[48px] rounded-xl font-bold text-sm bg-rose-600 hover:bg-rose-700 text-white shadow-lg shadow-rose-600/30 transition-all focus:outline-none focus:ring-2 focus:ring-rose-400"
            >
        ...
        <div
          className="absolute -right-16 -top-16 w-80 h-80 rounded-full bg-emerald-500/10 blur-3xl pointer-events-none"
          aria-hidden="true"
        />
        <div
          className="absolute -left-16 -bottom-16 w-80 h-80 rounded-full bg-blue-500/10 blur-3xl pointer-events-none"
          aria-hidden="true"
        />
      </section>
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
            ...
            {selectedEpisodeId && (
              <button
                ...
                className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors cursor-pointer"
              >
      ...
      <section aria-label="Longitudinal Care History Timeline" className="space-y-6">
        ...
        {selectedEpisodeId && (
          <div className="p-3.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 flex items-center justify-between text-xs text-emerald-900 dark:text-emerald-200">
      ...
      <section
        ...
        className="p-6 rounded-2xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs text-slate-600 dark:text-slate-400 space-y-3"
      >
        ...
        <div className="flex flex-wrap items-center gap-y-1 gap-x-4 pt-2 border-t border-slate-200 dark:border-slate-800 text-slate-500">
