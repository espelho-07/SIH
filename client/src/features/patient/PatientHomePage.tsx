...
export const PatientHomePage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
      ...
      {/* 2. UNIFIED PATIENT CARE ATTENTION & STATUS CARD */}
      <section aria-label="Patient Care Attention and Status">
        {unresolvedActions.length > 0 ? (
          /* Priority 1: Outstanding Clinical Action */
          <div className="p-4 sm:p-5 bg-white rounded-2xl border border-amber-300 ring-2 ring-amber-50 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="space-y-0.5">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Link
                    ...
                    className="font-mono text-xs font-extrabold text-amber-900 bg-amber-100/80 hover:bg-amber-200 px-2 py-0.5 rounded border border-amber-300 transition-colors inline-flex items-center gap-1"
                  >
                    <span>{unresolvedActions.length} Pending</span>
                ...
                {/* Inline Queue Pill if patient is also currently waiting in queue */}
                {activeQueueToken && (
                  <div className="pt-1 flex items-center gap-2 text-xs text-[#0F5147]">
                    <Clock className="w-3.5 h-3.5 shrink-0" />
                    <span>
                      Token <strong className="font-mono">{activeQueueToken.tokenNumber}</strong>: Now serving{' '}
                      <strong className="font-mono">{activeQueueToken.currentServingToken}</strong> ({activeQueueToken.positionInQueue} ahead).
                    </span>
                    <Link to="/patient/queue" className="font-semibold underline ml-1">
                      Track Queue →
                    </Link>
                  </div>
                )}
            ...
            <div className="flex flex-wrap items-center gap-2 self-end sm:self-center">
              {unresolvedActions.length > 1 && (
                ...
                >
                  <span>Action Center ({unresolvedActions.length})</span>
                </Link>
              )}
              <Link
          ...
          /* Priority 2: Active Hospital Referral */
          <div className="p-4 sm:p-5 bg-white rounded-2xl border border-amber-300 ring-2 ring-amber-50 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-xl bg-amber-50 flex items-center justify-center text-amber-700 shrink-0 border border-amber-200">
          ...
          /* Priority 3: Active Live OPD Queue */
          ...
          /* Priority 4: Upcoming Scheduled Appointment */
          <div className="p-4 sm:p-5 bg-white rounded-2xl border border-[#D0EAE6] shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-xl bg-[#F2F9F8] flex items-center justify-center text-[#0F5147] shrink-0 border border-[#D0EAE6]">
          ...
          /* Priority 5: Recommended Follow-Up Due */
          ...
          /* Priority 6: Calm Default / Fast-Track OPD Booking */
          <div className="p-4 sm:p-5 bg-white rounded-2xl border border-slate-200 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-[#0F5147] hover:bg-[#0B3D35] text-white text-xs font-semibold rounded-xl active:scale-95 transition-all shadow-2xs self-end sm:self-center shrink-0 touch-target"
            >
