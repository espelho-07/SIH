...
export const PrescriptionsMedicinesPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      >
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-[#F2F9F8] text-[#0F5147] border border-[#D0EAE6]">
                <Pill className="w-3.5 h-3.5 text-[#0F5147]" aria-hidden="true" />
          ...
          <div className="flex items-center gap-2 self-start md:self-center">
            <span className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-2xl bg-amber-50 text-amber-900 border border-amber-200 text-xs font-bold">
      ...
      <section aria-label="Section Navigation" className="border-b border-slate-200 pb-3">
        <div className="flex flex-wrap items-center gap-3">
          ...
          >
            ...
            <span className={`px-2 py-0.5 rounded-full text-xs font-extrabold ${activeSection === 'PRESCRIPTIONS' ? 'bg-white/20 text-white' : 'bg-slate-100'}`}>
              {activeRxCount}
            </span>
          </button>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="relative w-full md:w-96">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 shadow-xs"
              />
              {searchQuery && (
                <button
                  type="button"
