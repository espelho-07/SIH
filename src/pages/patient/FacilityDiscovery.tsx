    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors"
        >
        ...
        <CardContent className="p-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Search hospital, area, district or service..."
              className="h-10 w-full rounded-lg border border-slate-200 bg-slate-50 pl-9 pr-10 text-sm outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
            />
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="h-10 w-full rounded-lg border border-slate-200 bg-slate-50 px-3 text-xs text-slate-700 outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                >
                  <option value="ALL">
                    All Hospitals
                  </option>
      ...
      {viewMode === 'LIST' && filteredFacilities.length > 0 && (
        ...
        <div className="space-y-2.5">
          ...
          {filteredFacilities.map((facility) => (
            ...
            <Card
              key={facility.id}
              className="border-slate-200 shadow-sm transition-all hover:border-teal-300 hover:shadow-md"
            >
                  ...
                  <div className="flex gap-2 lg:w-[190px]">
                    ...
                    >
                      <Button
                        variant="primary"
                        size="sm"
                        className="h-8 w-full bg-teal-700 text-[11px] hover:bg-teal-800"
                      >
                        Get Token
                      </Button>
                    </Link>
        ...
        <Card className="border-slate-200">
          ...
          <CardContent className="py-10 text-center">
            ...
            <p className="mt-1 text-xs text-slate-500">
              No hospitals match your current search and filters.
            </p>
      ...
      <div className="flex items-center gap-2.5 rounded-lg border border-teal-100 bg-teal-50 px-3 py-2.5">
        ...
        <div>
          ...
          <p className="text-[10px] text-teal-700">
            Search by hospital, district, service or use the filters above.
          </p>
