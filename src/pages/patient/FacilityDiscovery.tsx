                  ...
                  <div className="flex min-w-0 items-start gap-3 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {facility.isOpen ? (
                          <span className="inline-flex rounded-full border border-emerald-200 bg-emerald-50 px-2.5 py-0.5 text-[10px] font-semibold text-emerald-700">
                            {t('facilities.openNow', 'Open Now')}
                          </span>
                        ) : (
                          <span className="inline-flex rounded-full border border-slate-200 bg-slate-100 px-2.5 py-0.5 text-[10px] font-semibold text-slate-500">
                            {t('facilities.closed', 'Closed')}
                          </span>
                        )}
                        {facility.emergencyAvailable && (
                          <span className="inline-flex rounded-full border border-rose-200 bg-rose-50 px-2 py-0.5 text-[9px] font-bold text-rose-700">
                            {t('facilities.emergency', 'Emergency 24/7')}
                          </span>
                        )}
                      </div>
