...
export const TopNavbar: React.FC<{ onToggleSidebar?: () => void; isSidebarOpen?: boolean }> = ({
  ...
  // Keep activeLang in sync with i18n
  React.useEffect(() => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-xs">
      <div className="flex h-16 items-center justify-between px-3 sm:px-6">
        ...
        {/* Right Controls: Status, Mobile Location, Language, Profile */}
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-slate-200">
            ...
            <button
              ...
              title={t('navbar.signOut', 'Sign Out')}
              aria-label={t('navbar.signOut', 'Sign Out')}
            >
