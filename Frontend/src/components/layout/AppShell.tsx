  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col antialiased">
      ...
      <div className="flex flex-1 min-w-0 w-full overflow-x-hidden">
        ...
        {/* Content Viewport with pb-24 on mobile for BottomNav */}
        <main className="flex-1 min-w-0 overflow-y-auto overflow-x-hidden px-3 sm:px-6 lg:px-8 py-4 sm:py-6 pb-24 md:pb-10 max-w-7xl mx-auto w-full">
          {children}
        </main>
      </div>
